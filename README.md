...
Модуль `m2424::profile_report` формирует табличное описание выбранных CKKS-параметров. Он нужен для презентации и экспериментов: параметры профиля считаются из кода, а не переписываются вручную.
